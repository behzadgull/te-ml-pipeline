...
note; on the 2026-08-17 re-run, post step 8/9 row-drop fix, it is closer
to 16x, 279,857 rows vs 17,157 successfully featurized unique formulas).
Two deliberately different composition-based
